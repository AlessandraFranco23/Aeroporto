...
//Classe para agrupar as queries
public class SQL {
    ...
    public static final String DELETE_COMPANHIA = "DELETE FROM COMPANHIA WHERE id = ?";
    public static final String UPDATE_COMPANHIA = "UPDATE COMPANHIA SET nome = ? WHERE id= ?";
    ...
    public static final String DELETE_HANGAR = "DELETE FROM HANGAR WHERE id = ?";
    public static final String UPDATE_HANGAR = "UPDATE HANGAR SET nome = ? WHERE id= ? ";
    ...
    public static final String DELETE_PISTA = "DELETE FROM PISTA WHERE id = ? ";
    public static final String UPDATE_PISTA = "UPDATE PISTA SET nome = ? WHERE id= ?";
    ...
    public static final String DELETE_AVIAO = "DELETE FROM AVIAO WHERE id = ?" ;
    public static final String UPDATE_AVIAO = "UPDATE AVIAO SET nome = ? WHERE id= ?";
    ...
    public static final String DELETE_HELICOPTERO = "DELETE FROM HELICOPTERO WHERE id = ?";
    public static final String UPDATE_HELICOPTERO = "UPDATE HELICOPTERO SET nome = ? WHERE id= ?";
    ...
    public static final String UPDATE_JATO = "UPDATE JATO SET nome = ? WHERE id= ?";
    ...
    public static final String DELETE_VOO = "DELETE FROM VOO WHERE id = ?";
    public static final String UPDATE_VOO = "UPDATE VOO SET nome = ? WHERE id= ?";
}
